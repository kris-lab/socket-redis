...
module.exports = (function() {
  ...
  var pluginManager
	 ...
	 * @constructor
	 */
	function Worker(port, sockjsClientUrl, sslOptions, pluginController) {
	...
	var listen = function(port, sslOptions) {
		...
		sockjsServer.on('connection', function(connection) {
			...
			connection.on('data', function(data) {
              ...
              pluginManager.trigger('subscribe', connection, eventData)
              ...
              pluginManager.trigger('unsubscribe', connection, eventData)
              ...
              pluginManager.trigger('message', connection, eventData)
              ...
              pluginManager.trigger('publish', connection, eventData)
